document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".o-u-navigation-list");
  const headerRef = document.querySelector(".o-u-header");
  const navigationRef = document.querySelector(".o-u-navigation");
  ...
  document.querySelectorAll(".o-u-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".o-u-toggle-button img");
